...
export const CHARACTER_VISUALS = {
  ...
  bladedancer: { body:'petite',   stance:'draw',    head:'longKnot',outer:'sash',       attack:'drawCut',accent:'petal', face:'cute' },
  ...
  drummer:     { body:'petiteRobe',stance:'open',   head:'doubleBun',outer:'warDrum',   attack:'beat',   accent:'pulse', face:'cheerful' },
