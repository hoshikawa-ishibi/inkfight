...
export const CODEX = [
  ...
  },
  {
    ...
    body:
      ...
      " 倍重击，并扣除 " +
      CRIT_METER_FULL +
      " 点，溢出的锋芒保留。每名队员的当前锋芒直接显示在队员带上；选中人物后，技能区会标出哪一招现在必定重击。多段攻击每段分别结算。",
  },
  {
    id: "multihit",
    icon: "✶",
  ...
  },
  {
    ...
    icon: "◌",
    title: "状态何时变化",
    body: "每个队伍回合开始，该队所有存活角色一起推进状态：中毒伤害、增益时长和被动各结算一次。同轮多招不会额外推进时间。腐化会叠层；净化可清除负面。点任意角色会打开「角色详情」，显示全部层数和时长。",
  },
  {
    id: "taunt",
    icon: "↗",
  ...
  },
  {
    ...
    icon: "⌘",
    title: "镜头与操作",
    body: "点击 3D 人物或下方立绘选人，点技能后再点目标。选目标时可取消，墨量不会扣除。电脑数字键 1–4 选技能、E 收笔、Esc 取消目标。拖动战场旋转，滚轮缩放，近景与全景可切换。右上角「战斗记录」用于回看本局每次伤害、治疗、状态与击倒；点角色可切到角色详情。设置里可减少动态效果。",
  },
  {
    id: "scene",
    icon: "△",
